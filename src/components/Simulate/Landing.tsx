...
const modalContent =
  'เหตุการณ์ต่อไปนี้เป็นเรื่องที่สมมติขึ้น อาการที่ตัวละครพบในเนื้อเรื่อง อาจไม่ใช่อาการทั้งหมด ที่ใกล้เคียงกับอาการที่ผู้สูงอายุพบในชีวิตจริง หากคุณสงสัยว่าตัวเองหรือผู้สูงอายุในครอบครัว มีความเสี่ยง  สามารถทำการคัดกรองเบื้องต้น ด้วยตนเองผ่านลิงก์แบบทดสอบหน้าสุดท้ายของ เว็บไซต์'
