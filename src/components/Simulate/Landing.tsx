...
const modalContent =
  'เหตุการณ์ต่อไปนี้เป็นเรื่องที่สมมติขึ้น อาการที่ตัวละครพบในเนื้อเรื่อง อาจไม่ใช่อาการทั้งหมดที่ใกล้เคียงกับอาการที่ผู้สูงอายุพบในชีวิตจริง<br/><br/> หากคุณสงสัยว่าตัวเองหรือผู้สูงอายุในครอบครัวมีความเสี่ยง  สามารถทำการคัดกรองเบื้องต้นด้วยตนเอง ผ่านลิงก์แบบทดสอบหน้าสุดท้ายของเว็บไซต์'
  ...
  return (
    <div className="fixed w-full h-full bg-black">
      <div className="flex justify-center w-full">
        <img src={body} alt="body" className={`absolute bottom-0 z-0 object-cover sm:h-full ${bgColor}`} />
      </div>
