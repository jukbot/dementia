  ...
  return (
    <div className="flex flex-col space-y-8 text-center text-white">
      <p className="text-lg font-light font-pridi">
        ...
        <br /> จะมีผู้ที่ป่วยอัลไซเมอร์ซึ่งเป็นภาวะสมองเสื่อม
        <br /> ประเภทที่พบมากที่สุด อย่างน้อย
      </p>
      <p className="text-3xl font-normal">1 คน</p>
      <p className="text-lg font-light font-pridi">
        ในปี พ.ศ. 2573 ประเทศไทยจะมีจำนวนผู้สูงอายุ ที่ป่วยเป็นโรคอัลไซเมอร์ประมาณ
      </p>
      <p className="text-4xl font-normal">1 แสนคน/ปี</p>
